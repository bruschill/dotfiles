...
s0_mode_modes = 1;
s0_viewport_matches = name=chromium-browser;name=empathy;name=Banshee;name=gvim;name=ubuntu-tweak;name=software-center;class=VirtualBox;
s0_viewport_x_values = 1;2;2;1;2;2;2;
s0_viewport_y_values = 1;1;1;2;2;2;2;
